...
```
At first glance, people with higher education level are likely to earn more. We then ran a chi-squared test and produced the following:
...
```
The Chi-squared test revealed a statistically signicant assocation between wage and education level in the field of statistics. So, we should keep purusing those higher degrees not only for the advancement of personal knowledge, but for higher wages aswell.
